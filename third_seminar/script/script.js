...
// let num2 = Number.parseFloat(prompt("Ввкдите второе число: "))
// function sum(firstNum, secondNum){
//     return firstNum + secondNum;
// }
// alert(`Результат сложения чисел ${num1} и ${num2} равен ${num1 + num2}`);

// Задача 4: вывести на экран в диалоговом окне текст с сообщением “Вам хорошо живется?”и кнопками 
// «ОК», «Отмена», для чего необходимо использовать confirm.- При нажатии на кнопку “ОК” вывести 
// в диалоговом окне текст с сообщением “Тогда мы идем к вам!”.- При нажатии на кнопку “Отмена” вывести 
...
// }
// isGoodLife ? alert("Тогда мы идем к Вам!") : alert("Ну вы держитесь там!"); //тернарный вариант
